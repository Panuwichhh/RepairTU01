    ...
    <h1 className="mt-4 ml-[3rem] text-[3rem]">INFORMATION</h1>
      <form className=" ml-5 justify-center flex ">
        <div className="flex item-center justify-center w-full h-[50rem]  ">
          <label htmlFor="dropzone-file" className="  flex flex-col items-center justify-center bg-gray-200 h-auto w-full mx-5  mb-[2rem]  mt-[3rem] border rounded-[35px] cursor-pointer hover:bg-gray-400 hover:border-black border-4 border-dashed border-red-400">
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
              <i className="fa-regular fa-image text-[5rem]"></i>
            </div>
            <div className="span">
              UPLOAD HERE
            </div>
        ...
        <div className=" shadow-xl mt-[3rem] h-full item-center bg-gray-200 mx-5 mb-5 rounded-[35px] p-4 w-[45rem] bg-gradient-to-b from-[#FF0000] to-[#FFD705] shadow-2xl">
          <div className="mb-5">
            <label htmlFor="email" className="block mb-2 text-lg  font-medium  text-black ">สถานที่</label>
          ...
          <div className="mb-5">
            <label htmlFor="email" className="block mb-2 text-lg  font-medium  text-black ">สิ่งที่ต้องการแก้ไข</label>
          ...
          <div className="mb-5">
            <label htmlFor="email" className="block mb-2 text-lg  font-medium  text-black ">รายละเอียดเพิ่มเเติม</label>
          ...
          <div className="flex items-center mb-4">
            ...
            <label htmlFor="checkbox-1" className="ms-2 text-lg font-medium text-gray-900 ">ยืนยันข้อมูลแจ้งซ่อม</label>
          </div>
