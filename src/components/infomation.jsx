    ...
    return (
        <>
            <div className='w-full flex flex-col md:flex-row flex-wrap bg-[#F6F6F6]'>
                ...
                <div className="w-full h-[25rem] sm:h-[41rem]  md:w-1/2 flex flex-col justify-center items-center bg-gradient-to-l from-[#FF0000] to-[#FFD705] rounded-tr-[2rem] rounded-br-[2rem] ">
                ...
                <div className='w-full h-[25rem]  sm:h-[35rem] md:w-1/2  flex justify-center items-center mt-10'>
